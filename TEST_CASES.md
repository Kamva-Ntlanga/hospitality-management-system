...
| Test Case ID | Requirement ID | Description | Steps | Expected Result | Actual Result | Status |
|--------------|----------------|-------------|-------|-----------------|---------------|--------|
| TC-NF-01 | NFR-P1 | Performance Test: Page load time | 1. Navigate to search page<br>2. Measure time to fully load<br>3. Repeat 10 times for average | Page loads within 2 seconds on standard broadband connection | | |
| TC-NF-02 | NFR-SE2 | Security Test: Failed login lockout | 1. Attempt login with wrong password 5 times<br>2. Try 6th attempt with correct password | Account locked after 5 attempts; error message displayed; user cannot login for 15 minutes | | |
